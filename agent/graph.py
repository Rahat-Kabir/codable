...
def coder_agent(state: dict) -> dict:
    ...
    user_prompt = (
        ...
        f"Existing content:\n{existing_content}\n"
        "Use write_file(path, content) to save your changes. Use list_files(directory) to list files. Use read_file(path) to read files."
    )

    # Create a more explicit tool list with better naming
